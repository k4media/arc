...
<div id="page" class="site">
	...
	<header id="masthead" class="site-header">
		<div class="site-branding">
			...
			$arc_description = get_bloginfo( 'description', 'display' );
			if ( $arc_description || is_customize_preview() ) :
				?>
				<p class="site-description"><?php echo $arc_description; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?></p>
			<?php endif; ?>
		</div><!-- .site-branding -->
